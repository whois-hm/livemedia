 ...
 */
class swxcontext_class final/*all function has in this class...........*/
{
...
public:
	...
	swxcontext_class(const swxcontext_class &rhs) = delete;
	swxcontext_class(swxcontext_class &&rhs) = delete;
	/*
